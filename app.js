...
currentSection=parseInt(e.dataset.section);currentMode=sectionModes[currentSection];closeMobileMenu();if(chatOpen){closeChat()}renderContent();renderRightModes()
});
});
