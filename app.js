...
function addMessageHTML(role,html){if(historyStack.length>0){historyStack[0].msgs=chatMessages.slice(0);try{localStorage.setItem("fp_history",JSON.stringify(historyStack))}catch(e){}}
