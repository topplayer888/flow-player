...
'<button onclick="triggerKyrieImageUpload()" style="width:100%;padding:8px 10px;border-radius:8px;border:0;background:var(--purple);color:#fff;font-size:12px;font-weight:600;cursor:pointer;margin-bottom:8px">上传数据截图</button>'+
...
if(!/image\/(png|jpeg|webp)/.test(file.type)&&!/\.(png|jpe?g|webp)$/i.test(file.name||"")){setMayuanDocStatus("请上传 png、jpg、jpeg 或 webp 图片","error");return}
