...
function formatScript(t){
 return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")
  ...
  .replace(/^(\d+)\. (.+)$/gm,"<div style=\"margin:4px 0 4px 8px\"><span style=\"color:var(--purple)\">$1.</span> $2</div>")
