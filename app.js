...
handleResize();
renderContent();
updateApiStatus();document.getElementById("btn-save-sound").addEventListener("click",saveSoundSettings);document.querySelector(".sidebar-settings-btn").addEventListener("click",function(e){e.stopPropagation();openSettings()});document.getElementById("logo-area").addEventListener("click",function(e){e.stopPropagation();goHome()});
