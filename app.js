...
6. 生成脚本：必须包含脚本策略、口播逐字稿、拍摄画面、视觉高光、可替换要素、测试目的、裂变方向。口播逐字稿每句话单独换行。
