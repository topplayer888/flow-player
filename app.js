...
animate();
var soundMode=parseInt(localStorage.getItem("fp_soundMode")||"1");var soundEnabled=localStorage.getItem("fp_soundEnabled")==="1";function playMoveSound(){if(!soundEnabled)return;if(soundMode===1)playElectric();else playWaterFlow()}function playClickSound(){if(!soundEnabled)return;if(soundMode===1)playClick();else playWaterDrop()}function updateSoundUI(){var s=document.getElementById("set-sound-mode");if(s)s.value=soundMode;var t=document.getElementById("set-sound-toggle");if(t)t.value=soundEnabled?"1":"0"}var currentTheme=localStorage.getItem("fp_theme")||"enterprise";var themeWasteland=false;function applyTheme(t){currentTheme=t;themeWasteland=t==="wasteland";document.body.classList.remove("theme-wasteland","theme-light","theme-pureblack","theme-enterprise");if(t==="wasteland"){document.body.classList.add("theme-wasteland");var li=document.querySelector(".logo-icon");if(li)li.textContent="💀";var nis=document.querySelectorAll(".nav-icon");if(nis[0])nis[0].textContent="🏜️";if(nis[1])nis[1].textContent="⚠️";if(nis[2])nis[2].textContent="📻"}else if(t==="light"){document.body.classList.add("theme-light");var li=document.querySelector(".logo-icon");if(li)li.textContent="✨";var nis=document.querySelectorAll(".nav-icon");if(nis[0])nis[0].textContent="📝";if(nis[1])nis[1].textContent="💎";if(nis[2])nis[2].textContent="📊"}else if(t==="pureblack"){document.body.classList.add("theme-pureblack");var li=document.querySelector(".logo-icon");if(li)li.textContent="◈";var nis=document.querySelectorAll(".nav-icon");if(nis[0])nis[0].textContent="🎬";if(nis[1])nis[1].textContent="💡";if(nis[2])nis[2].textContent="📡"}else if(t==="enterprise"){document.body.classList.add("theme-enterprise");var li=document.querySelector(".logo-icon");if(li)li.textContent="⚡";var nis=document.querySelectorAll(".nav-icon");if(nis[0])nis[0].textContent="🎬";if(nis[1])nis[1].textContent="💡";if(nis[2])nis[2].textContent="📡"}else{var li=document.querySelector(".logo-icon");if(li)li.textContent="⚡";var nis=document.querySelectorAll(".nav-icon");if(nis[0])nis[0].textContent="🎬";if(nis[1])nis[1].textContent="💡";if(nis[2])nis[2].textContent="📡"}localStorage.setItem("fp_theme",t);var s=document.getElementById("set-theme-mode");if(s)s.value=t}function updateThemeUI(){var s=document.getElementById("set-theme-mode");if(s)s.value=currentTheme}function saveThemeSettings(){localStorage.setItem("fp_theme",currentTheme);document.getElementById("settings-overlay").classList.remove("open");console.log("主题已保存:",currentTheme)}applyTheme(currentTheme);
