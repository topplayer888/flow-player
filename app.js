...
icon:"📈",
features:"直播策划 · 脚本生成 · 老师训练 · 实时中控及诊断复盘\n知识付费直播闭环",
...
text=String(text||"");
if(text.indexOf("口播逻辑质量硬性要求")>=0)return text;
return text+getCopyCoherenceRule();
}
