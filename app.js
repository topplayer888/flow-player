...
function saveHistory(){if(historyStack.length>0){historyStack[0].msgs=chatMessages.slice(0);try{localStorage.setItem('fp_history',JSON.stringify(historyStack))}catch(e){}}}function addMessageHTML(role,html){
chatMessages.push({role:role,content:html});saveHistory();
var msgs=document.getElementById("chat-messages");
