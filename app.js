...
if(extra)prompt+="\n\n## 补充信息\n"+extra;
prompt+="\n\n请严格按照马源内容体系工作流程输出：\n1. 策略分析\n2. 脚本手法选择\n3. 视觉手法匹配\n4. 完整脚本（开场+主体+结尾）\n5. 专项建议";
var resultArea=document.getElementById("form-result-area");
resultArea.innerHTML='<div style="text-align:center;color:var(--text-muted);padding:20px">⏳ 生成中...</div>';
